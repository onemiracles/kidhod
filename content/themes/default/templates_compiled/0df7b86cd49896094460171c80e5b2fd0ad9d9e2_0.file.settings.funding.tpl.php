<?php
/* Smarty version 4.3.2, created on 2023-10-09 07:22:08
  from '/www/wwwroot/m.kidhod.la/content/themes/default/templates/settings.funding.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_6523aa207e65c9_05255615',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0df7b86cd49896094460171c80e5b2fd0ad9d9e2' => 
    array (
      0 => '/www/wwwroot/m.kidhod.la/content/themes/default/templates/settings.funding.tpl',
      1 => 1694155587,
      2 => 'file',
    ),
  ),
...
function content_6523aa207e65c9_05255615 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="card-header with-icon">
  <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"funding",'class'=>"main-icon mr15",'width'=>"24px",'height'=>"24px"), 0, false);
echo __("Funding");?>
          ...
          <div class="col-md-9">
            <h6>
              <span class="badge badge-lg bg-info">
                <?php echo print_money(smarty_modifier_number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_funding_balance'],2));?>
 ...
 <?php echo print_money($_smarty_tpl->tpl_vars['system']->value['funding_min_withdrawal']);?>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            <?php }?>
            <?php if (in_array("moneypoolscash",$_smarty_tpl->tpl_vars['system']->value['funding_payment_method_array'])) {?>
              <div class="form-check form-check-inline">
            ...
            <?php if (in_array("custom",$_smarty_tpl->tpl_vars['system']->value['funding_payment_method_array'])) {?>
              <div class="form-check form-check-inline">
                ...
                <label class="form-check-label" for="method_custom"><?php echo __($_smarty_tpl->tpl_vars['system']->value['funding_payment_method_custom']);?>
</label>
              </div>
            <?php }?>
          </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-sm-6">
        <div class="section-title mb20">
          <?php echo __("Your Funding Balance");?>
